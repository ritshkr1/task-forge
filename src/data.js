export const TASKS_DATA = [
  {
    "id": "TODAY#1",
    "title": "Install & Setup Toastr",
    "description": "Get `react-hot-toast` or `react-toastify` into the project. Trigger a success toast when a task is deleted (since delete already works).",
    "status": "TODO",
    "comments": 0,
    "commentsList": [
    ],
  ...
  {
    "id": "TODAY#2",
    "title": "Logic: Add New Task",
    "description": `Map your "Add Task" Modal inputs to a state object. On "Save," push that object into your main tasks array with a unique ID.`,
    "status": "TODO",
    "comments": 0,
    "commentsList": [
    ],
  ...
  {
    "id": "TODAY#3",
    "title": "Logic: Search Bar",
    "description": `Create an input at the top of your list. Use a ".filter()" method to show only the tasks whose titles include the search string (Case-insensitive)`,
    "status": "TODO",
    "comments": 0,
    "commentsList": [
    ],
...
{
    "id": "TODAY#4",
    "title": "Logic: Edit Task (Data Fetch)",
    "description": "When the 'Edit' button is clicked, pass that specific task's ID to the modal and pre-fill the input fields with that task's existing data.",
    "status": "TODO",
    "comments": 0,
    "commentsList": [],
    "assignee": { "name": "Ritesh Kumar", "avatar": "RK" },
  ...
  {
    "id": "TODAY#5",
    "title": "Logic: Edit Task (State Update)",
    "description": "On 'Update,' use .map() to find the task by ID in your state and replace it with the new values. Trigger a 'Task Updated' Toast.",
    "status": "TODO",
    "comments": 0,
    "commentsList": [],
    "assignee": { "name": "Ritesh Kumar", "avatar": "RK" },
  ...
  {
    "id": "TODAY#6",
    "title": "Logic: Advanced Filtering",
    "description": "Implement the filter logic (e.g., filter by 'Status' or 'Priority') using the same state-driven approach as the search bar.",
    "status": "TODO",
    "comments": 0,
    "commentsList": [],
    "assignee": { "name": "Ritesh Kumar", "avatar": "RK" },
  ...
  {
    "id": "TODAY#7",
    "title": "Logic: State Persistence",
    "description": "Wrap your state updates in a useEffect that saves the tasks array to localStorage so you don't lose data on refresh.",
    "status": "TODO",
    "comments": 0,
    "commentsList": [],
    "assignee": { "name": "Ritesh Kumar", "avatar": "RK" },
  ...
  {
    "id": "TODAY#8",
    "title": "Final Logic Check",
    "description": "Ensure your 3 Meaningful Commits are pushed to GitHub.",
    "status": "TODO",
    "comments": 0,
    "commentsList": [],
    "assignee": { "name": "Ritesh Kumar", "avatar": "RK" },
...
// export default DEFAULT_USER_PROFILE;